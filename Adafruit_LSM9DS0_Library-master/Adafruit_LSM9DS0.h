...
class Adafruit_LSM9DS0
{
  public:
    ...
    lsm9ds0Vector_t accelCalibration;
	lsm9ds0Vector_t velocity;
	lsm9ds0Vector_t prevVelocity;
	lsm9ds0Vector_t distance;
	
	// Mag, Gyro, & Temp Data Storage
    ...
    void    read        ( void );
    void    readAccel   ( void );
    void	calcVelocity(sensors_event_t* prevAccel, sensors_event_t* accel, float timeDif);
    void	calcDistance(float timeDif);
    void    readMag     ( void );
    void    readGyro    ( void );
    void    readTemp    ( void );
